function newArrival() {
  ...
  productName1.innerText = "Cereal And Milk";
  productName2.innerText = "Choco Cherry";
  productName3.innerText = "Chokobar";
  productName4.innerText = "chocolate Wafer";
  productName5.innerText = "Cookie";
  productName6.innerText = "Cookies Cream";
...
function bestSeller() {
  ...
  productName1.innerText = "Waffle Cones";
  productName2.innerText = "Wafer Ice Cream";
  productName3.innerText = "Vanilla";
  productName4.innerText = "Toasted Strawberry";
  productName5.innerText = "Pretzel Cones";
  productName6.innerText = "Lemon Ice Cream";
